...
class MineSweeper(object):
    ...
    def __init__(self, width, height, nmines):
        ...
        # matrix indicating which squares have been clicked, true if clicked.
        self.clicked = np.zeros((self.width, self.height), dtype=bool)

        # matrix indicating which squares have been flagged, true if flagged.
    ...
    def _button_press(self, event):
        ...
        x, y = self.translate_from_ui_click_to_matrix_cordinate(i, j)
