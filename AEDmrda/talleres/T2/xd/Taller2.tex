...
\hypersetup{
  pdftitle={Taller 2},
  pdfauthor={Santiago Aillón, Santiago Arévalo, Juan José Caballero y Laura Ortiz},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Taller 2}
\author{Santiago Aillón, Santiago Arévalo, Juan José Caballero y Laura
Ortiz}
\date{}
...
\subsection{\texorpdfstring{1. Las siguientes son 5 medidas sobre las
variables
...
Se calcula las medias de cada variable, para obtener el vector de
medias:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{X }\OtherTok{=} \FunctionTok{colMeans}\NormalTok{(df)}
\NormalTok{X}
\end{Highlighting}
\end{Shaded}
