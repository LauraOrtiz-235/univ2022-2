---
title: "Taller 7"
author: "Santiago Aillón, Juan José Caballero y Laura Ortiz"
date: "2022-11-09"
...
for (i in 1:nrow(X1)) {
  ...
  y0_X1 = y_gorrito%*%X1[i,]
  y0_X2 = y_gorrito%*%X2[i,]
...
matrix_confusion = cbind(c(n1C,n1M), c(n2M,n2C))
matrix_confusion
```
...
```{r}
APER = ((n1M + n2M)/(nrow(X1)+nrow(X2)))*100
APER
```
